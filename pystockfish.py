...
class Engine(subprocess.Popen):
    ...
    '''
    def __init__(self, depth=2, movetime=1500, ponder=False, param={}, rand=False, rand_min=90, rand_max=110):
    ...
    def go_movetime(self):
        self.put('go movetime %s'%self.movetime)
    ...
    def bestmove(self):
        ...
        while True:
            ...
            if split_text[0]=='bestmove':
                try: move = split_text[1]
                except: move = None
                try: ponder = split_text[3]
                except: ponder = None
                return {'move': move,
                        'ponder': ponder,
                        'info': last_line,
